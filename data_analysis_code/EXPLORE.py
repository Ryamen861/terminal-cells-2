...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan  6 12:22:18 2026
...
trace_file = "data/traces_L3/1_Tr9R.traces"
G = trace_file_to_G(trace_file)
# color_plot_walk(G, f"trace_to_graph_images/{trace_file[15:21]}")
x = nx.get_node_attributes(G, "coords")